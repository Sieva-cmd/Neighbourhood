...
class Neighbourhood(models.Model):
    ...
    hood_logo = models.ImageField(upload_to='images/',default='v1639327874/images/default_drurzc.jpg')
    description = models.TextField(default=False)
    health_tell_no = PhoneField(null=True, blank=True)
    police_tel_no = PhoneField(null=True, blank=True)
    ...
    def find_neigborhood(cls,neigborhood_id):
        neigborhood =cls.objects.filter(id__in=neigborhood_id)
        return neigborhood
...
class Profile(models.Model):
    ...
    location =models.CharField(max_length=50,default=False)
